...
(function(factory) {
  ...
  notifyr = (function() {
    ...
    Notifyr.prototype.render = function() {
      ...
      this.notice = $('<div>', {
        "class": "notification notification-" + this.options.FreightApp + " " + (this.options.classes.join(' ')),
        html: $('<div>', {
      ...
      offset = this.options.FreightApp.match(/left/) ? {
    ...
    Notifyr.prototype.animateOptions = function(state) {
      ...
      if (state === 'show') {
        opts.opacity = 1;
        if (this.options.FreightApp.match(/left/)) {
